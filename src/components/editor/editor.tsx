    ...
    <div className='relative w-full'>
      <EditorRoot>
        <EditorContent
          ...
          className='min-h-96 outline-0 border-0 w-full border p-4'
          editorProps={{
            handleDOMEvents: {
            ...
            attributes: {
              class:
                'prose dark:prose-invert prose-headings:font-title font-default focus:outline-none max-w-full w-full'
            }
          }}
          onUpdate={({ editor }) => {
